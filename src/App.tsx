      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-6">
        ...
        <div className="text-center max-w-5xl mx-auto space-y-8">
          ...
          <div className="space-y-4 mb-8">
            <h2 className="text-xl md:text-2xl lg:text-3xl gta-subtitle leading-tight" style={{ 
              color: '#FFFFFF', 
              textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8), 1px 1px 2px rgba(0, 0, 0, 0.9)'
            }}>
              Unlock Your Exclusive GTA VI Countdown Clock
            </h2>
            <h3 className="text-lg md:text-xl lg:text-2xl gta-secondary leading-tight" style={{ 
              color: '#FFFFFF', 
              textShadow: '2px 2px 4px rgba(0, 0, 0, 0.8), 1px 1px 2px rgba(0, 0, 0, 0.9)'
            }}>
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            {/* Scarcity Reminder */}
            <p className="text-lg md:text-xl text-yellow-300 font-bold gta-subtitle enhanced-text-visibility">
